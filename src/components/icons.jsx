...
const icon = (paths) => (
  <svg viewBox={viewBox} fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    {paths}
  </svg>
);
...
export const Icons = {
  ...
  invoice: icon(
    <>
      <path d="M8 3h9a2 2 0 0 1 2 2v15l-3-2-3 2-3-2-3 2V5a2 2 0 0 1 2-2z" />
...
export const renderIcon = (iconNode, size = 16) => (
  <span style={{ width: size, height: size, display: "inline-flex", flexShrink: 0 }}>{iconNode}</span>
);
